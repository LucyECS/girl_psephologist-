...
with open("Election Results\Federal2022\created\Federal2022FirstPref.csv") as results:
    ...
    print(HoverText["Brisbane"])

# Write to Federal2022HoverText.csv
with open("Election Results\Federal2022\created\Federal2022HoverText.csv", "w", newline="") as hovertext:
